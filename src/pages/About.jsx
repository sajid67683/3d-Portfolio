  ...
  return (
    <section className='max-container'>
      ...
      <div className='py-16'>
        ...
        <div className='flex flex-col gap-3 mt-5 text-slate-500'>
          <p>
          Having collaborated with a myriad of distinguished enterprises, 
          elevating my skill set and aligning with astute professionals, 
          allow me to present the comprehensive overview:
          </p>
        </div>
